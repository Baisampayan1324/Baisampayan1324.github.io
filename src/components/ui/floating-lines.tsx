...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // Cap pixel ratio low: this is a fill-rate-heavy fragment shader (loops over
    // every line per pixel), so rendering at native 2x+ DPR is what makes the
    // projects section stutter. 1.35 keeps it sharp enough while ~halving pixels.
    ...
    // Pause GPU work while the section is offscreen.
    const io =
